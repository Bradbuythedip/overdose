...
| **both serials combined**: arithmetic, interleave, digit-wise ops, letters+banknote meaning, 128-bit entropy readings, HMAC/PBKDF2/scrypt/WarpWallet pairings, text-index, transform closure | serial_combine.py | 10^8 scripts | **all null**, discovery to depth 4 (960,000 nodes, cap reported) |
